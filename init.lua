    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gT', vim.lsp.buf.typehierarchy, '[G]oto [T]ype Hierarchy')
...
package.path = package.path .. ';' .. vim.fn.expand '$HOME' .. '~/.luaver/luarocks/2.3.0_5.1/share/lua/5.1/?.lua'
package.path = package.path .. ';' .. vim.fn.expand '$HOME' .. '~/.luaver/luarocks/2.3.0_5.1/share/lua/5.1/?/init.lua'
